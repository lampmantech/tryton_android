...
/** The representation of a view of a given type. When loading a model view
 * it should always be build before giving it to the application.
 * The id of a ModelView should never be 0.
 * Loading is done by getting fields and arch, then building it with ArchParser.
 * See DataCache or TrytonCall for building example. */
