 ...
 * It holds loaded views and allows to explicitely define ids of views to
 * load in given types.
 * If either type or even ModelViewTypes is not set for a field, it means
 * that default views should be used. Also if a type is set to use the id 0
 * it means that the default view should be used. Once set the actual id
 * is updated. */
public class ModelViewTypes implements Serializable {
     ...
     * Use 0 to explicitely use default view. */
    ...
    /** Get the id of a view for a type. 0 means either use default one,
     * or that the type has not been explicitely set (thus use default). */
